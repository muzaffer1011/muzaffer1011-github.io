...
function nextSlide($para1, $para2) {
	...
	var screenFeedWidth = screen.width;
	...
	if (scrollfee == 2) {
		...
		if (screenFeedWidth < 767) {
			//alert(screenFeedWidth);
			if (topSlide < 100) {
			...
			else if ((topSlide < 232) && (topSlide > 101)) {
				$('.slideFocusFeedback').css('top', -71);
			}
			
			else if (topSlide == 233) {
				$('.slideFocusFeedback').css('top', -86);
			}
			
			else if ((topSlide < 350) && (topSlide > 234)) {
				$('.slideFocusFeedback').css('top', -71);
			}
			
			else if ((topSlide < 529) && (topSlide > 351)) {
	...
	if (showBottomSec == 2) {
			//alert('hi');
			$('.feedback-slide-21.feedback-slideshow-content').css('height', '530px');
			$('.feedback-slide-21 .feedback-slideshow-detail').css('height', '461px');
			
			$('.feedback-slide-22.feedback-slideshow-content').css('height', '530px');
			$('.feedback-slide-22 .feedback-slideshow-detail').css('height', '461px');
	}
...
function prevSlide($para1, $para2) {
	if($para1=='feedback-slide-1')
	{
		$('.feedback-slideshow-header').css('display', 'block');
		$('.feedback-slide-1').css('top', '40px');
